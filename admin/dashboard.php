...
$sql5 ="SELECT  B.BRANDNAME FROM tblbrands B,tblbooking BK,tblvehicles V,tblusers U WHERE U.EMAILID=BK.USEREMAIL AND BK.VEHICLEID=V.ID AND V.VEHICLESBRAND=B.ID AND U.FULLNAME='%$filtervalues%'; ";
